...
#SBATCH --job-name=13.1_ena_dowload_trimmomatic
...
java -jar /cluster/software/Trimmomatic/Trimmomatic-0.39/trimmomatic-0.39.jar PE -threads 28 \
 SRR4431659_1.fastq.gz SRR4431659_2.fastq.gz\
 SRR4431659_1_paired.fq.gz SRR4431659_1_unpaired.fq.gz \
 SRR4431659_2_paired.fq.gz SRR4431659_2_unpaired.fq.gz \
