...
#SBATCH --job-name=03_busco5_odb10_SalPil
...
#Input directory
IN=/cluster/home/lchueca/TBG_3759_Enen_assembly/00.7_relationed_species/Louro_et_al_2019-Sardine-proteins.fasta
#Linage
LIN=/cluster/software/busco/datasets/odb10_2021_09_02/actinopterygii_odb10
#Output directory
OUT=busco5_odb10_SalPil
#CPU per task
CPU=8
#Mode
MO=proteins
