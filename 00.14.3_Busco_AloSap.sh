...
#SBATCH --job-name=01_busco5_odb10_AloSap
...
#Input directory
IN=/cluster/home/lchueca/TBG_3759_Enen_assembly/00.7_relationed_species/GCF_018492685.1_fAloSap1.pri_genomic.fna
#Linage
LIN=/cluster/software/busco/datasets/odb10_2021_09_02/actinopterygii_odb10
#Output directory
OUT=busco5_odb10_AloSap
#CPU per task
CPU=8
#Mode
MO=genome
